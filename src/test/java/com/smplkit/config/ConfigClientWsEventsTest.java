...
class ConfigClientWsEventsTest {
    ...
    void setUp() throws ApiException {
        ...
        when(mockApi.listConfigs(null, null, null, null, null)).thenReturn(emptyList);
    }
    ...
    void configChanged_contentChanged_scopedFetch_listenerFires() throws ApiException {
        ...
        when(mockApi.listConfigs(null, null, null, null, null)).thenReturn(initList);
        ...
        verify(mockApi, times(1)).listConfigs(null, null, null, null, null); // only initial
    }
    ...
    void configsChanged_fullFetch_diffBasedFiring() throws ApiException {
        ...
        when(mockApi.listConfigs(null, null, null, null, null)).thenReturn(updatedList);

        configClient.simulateConfigsChanged(Map.of());

        assertNotNull(received.get(), "Listener should fire when content changes");
        // listConfigs called twice: once for init, once for configs_changed
        verify(mockApi, times(2)).listConfigs(null, null, null, null, null);
    }
    ...
    void configChanged_apiFetchThrows_isNoOp() throws ApiException {
        ...
        verify(mockApi, times(1)).listConfigs(null, null, null, null, null); // only initial call, not triggered by failed event
    ...
    void configChanged_withParentChain_parentFound_resolvesChain() throws ApiException {
        ...
        when(mockApi.listConfigs(null, null, null, null, null)).thenReturn(bothConfigs);
    ...
    void configChanged_withParentChain_parentNotFound_breaksLoop() throws ApiException {
        ...
        when(mockApi.listConfigs(null, null, null, null, null)).thenReturn(noParent);
