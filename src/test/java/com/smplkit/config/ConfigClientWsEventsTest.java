...
class ConfigClientWsEventsTest {
    ...
    void setUp() throws ApiException {
        ...
        when(mockApi.listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(emptyList);
    }
    ...
    void configChanged_contentChanged_scopedFetch_listenerFires() throws ApiException {
        ...
        when(mockApi.listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(initList);
        ...
        verify(mockApi, times(1)).listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull()); // only initial
    }
    ...
    void configsChanged_fullFetch_diffBasedFiring() throws ApiException {
        ...
        when(mockApi.listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(updatedList);
    ...
    void configChanged_apiFetchThrows_isNoOp() throws ApiException {
        ...
        verify(mockApi, times(1)).listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull()); // only initial call, not triggered by failed event
    ...
    void configChanged_withParentChain_parentFound_resolvesChain() throws ApiException {
        ...
        when(mockApi.listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(bothConfigs);
    ...
    void configChanged_withParentChain_parentNotFound_breaksLoop() throws ApiException {
        ...
        when(mockApi.listConfigs(isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(noParent);
