...
class LoggingClientTest {
    ...
    void start_isIdempotent() throws ApiException {
        ...
        verify(mockLoggersApi, times(1)).listLoggers((Boolean) null, null, null, null);
    }

    @Test
    void start_continuesEvenIfFetchFails() throws ApiException {
        when(mockLoggersApi.listLoggers((Boolean) null, null, null, null)).thenThrow(new ApiException(500, "server error"));
    ...
    void listGroups_mapsApiException() throws ApiException {
        when(mockLogGroupsApi.listLogGroups(null)).thenThrow(new ApiException(500, "server error"));
    ...
    void start_handlesGroupFetchApiException() throws ApiException {
        ...
        // Group fetch fails
        when(mockLogGroupsApi.listLogGroups(null)).thenThrow(new ApiException(500, "group fetch failed"));
