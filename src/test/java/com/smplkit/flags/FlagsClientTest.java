...
class FlagsClientTest {
    ...
    void list_returnsAllFlags() throws ApiException {
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(listResponse);
    ...
    void updateFlag_putsAndReturnsUpdatedFlag() throws ApiException {
        FlagResponse response = makeFlagResponse(TEST_FLAG_ID, "Updated Flag",
                "BOOLEAN", false, List.of(), Map.of());
        when(mockApi.updateFlag(eq(TEST_FLAG_ID), any(FlagRequest.class)))
                .thenReturn(response);
        ...
        verify(mockApi).updateFlag(eq(TEST_FLAG_ID), any(FlagRequest.class));
    }
    ...
    void updateFlag_unconstrained_sendsNullValues() throws ApiException {
        ...
        verify(mockApi).updateFlag(eq("max-retries"), any(FlagRequest.class));
    }
    ...
    void handleGet_lazyInit_callsListOnFirstEval() throws ApiException {
        ...
        verify(mockApi, atLeastOnce()).listFlags(isNull(), isNull(), isNull(), isNull(), isNull());
    }
    ...
    private void setupFlagStore(String id, String type, Object defaultValue,
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(
