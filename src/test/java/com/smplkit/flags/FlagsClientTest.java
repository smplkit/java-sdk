...
class FlagsClientTest {
    ...
    void list_emptyResponse() throws ApiException {
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(new FlagListResponse().data(List.of()));
    ...
    void handleGet_lazyInit_callsListOnFirstEval() throws ApiException {
        ...
        verify(mockApi, atLeastOnce()).listFlags(isNull(), isNull(), isNull(), isNull(), isNull(), any(), any(), isNull());
    }
