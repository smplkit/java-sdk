...
class FlagTest {
    ...
    // --- enableRules()/disableRules() per-environment mutation ---

    @Test
    void enableRules_setsEnabledTrue() {
        Flag<Boolean> flag = client.newBooleanFlag("my-flag", false);
    ...
    @Test
    void disableRules_setsEnabledFalse() {
        Flag<Boolean> flag = client.newBooleanFlag("my-flag", false);
    ...
    @Test
    void enableRules_createsEnvIfAbsent() {
        Flag<Boolean> flag = client.newBooleanFlag("my-flag", false);
        assertFalse(flag.getEnvironments().containsKey("new-env"));

        flag.enableRules("new-env");

        assertTrue(flag.getEnvironments().containsKey("new-env"));
    }

    // --- setDefault(value, environment) per-environment mutation ---

    @Test
    void setDefault_perEnv_setsDefault() {
        Flag<Boolean> flag = client.newBooleanFlag("my-flag", false);
    ...
    @Test
    void setDefault_perEnv_createsEnvIfAbsent() {
        Flag<String> flag = client.newStringFlag("color", "red");
        flag.setDefault("fallback", "production");
