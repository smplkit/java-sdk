...
class FlagsClientWsEventsTest {
    ...
    void flagChanged_forKeyX_onlyFiresXListener_notYListener() throws ApiException {
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(both);
    ...
    void flagChanged_contentChanged_scopedFetch_listenerFires() throws ApiException {
        ...
        verify(mockApi, times(1)).listFlags(isNull(), isNull(), isNull(), isNull(), isNull()); // only initial
    }
    ...
    void flagsChanged_fullFetch_diffBasedFiring() throws ApiException {
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(updated);
        ...
        verify(mockApi, times(2)).listFlags(isNull(), isNull(), isNull(), isNull(), isNull());
    }
    ...
    void flagsChanged_globalListenerFiresOnce() throws ApiException {
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(initial);
        client._connectInternal();
    ...
    private void setupList(String id, String type, Object defaultVal, Map<String, Object> environments)
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull())).thenReturn(resp);
    }
