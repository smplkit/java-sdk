...
class FlagsClientWsEventsTest {
    ...
    void flagChanged_contentChanged_scopedFetch_listenerFires() throws ApiException {
        ...
        verify(mockApi, times(1)).listFlags(isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), any(), any(), isNull()); // only initial
    }
    ...
    void flagsChanged_fullFetch_diffBasedFiring() throws ApiException {
        ...
        when(mockApi.listFlags(isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), any(), any(), isNull())).thenReturn(updated);
        ...
        verify(mockApi, times(2)).listFlags(isNull(), isNull(), isNull(), isNull(), isNull(), isNull(), any(), any(), isNull());
    }
