...
class PaginationTest {
    ...
    void env_listWithPagination_passesThrough() throws ApiException {
        ...
        when(mockEnvApi.listEnvironments(isNull(), isNull(), isNull(), isNull(), eq(2), eq(50), isNull())).thenReturn(resp);
    ...
    void env_asyncListWithPagination_delegatesToSync() throws Exception {
        ...
        when(mockEnvApi.listEnvironments(isNull(), isNull(), isNull(), isNull(), eq(3), eq(10), isNull())).thenReturn(resp);
