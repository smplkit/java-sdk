...
class TelemetryIntegrationTest {
    ...
    void flagsEvaluationRecordsMetricsOnCacheMiss() throws Exception {
        ...
        when(flagsApi.listFlags(nullable(String.class), nullable(Boolean.class), nullable(String.class), nullable(String.class), nullable(String.class), nullable(String.class), nullable(Integer.class), nullable(Integer.class), nullable(Boolean.class))).thenReturn(
    ...
    void configResolveRecordsMetric() throws Exception {
        ...
        when(configsApi.listConfigs(any(), any(), any(), any(), any(), any(), any())).thenReturn(listResp);
    ...
    void configChangesRecordedOnRefresh() throws Exception {
        ...
        when(configsApi.listConfigs(nullable(String.class), nullable(String.class), nullable(Boolean.class), nullable(String.class), nullable(Integer.class), nullable(Integer.class), nullable(Boolean.class)))
