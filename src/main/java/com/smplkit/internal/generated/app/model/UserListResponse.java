...
public class UserListResponse {
  ...
  public UserListResponse data(@jakarta.annotation.Nonnull List<UserResource> data) {
    this.data = data;
    return this;
  }

  public UserListResponse addDataItem(UserResource dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<UserResource> data) {
    this.data = data;
  }
