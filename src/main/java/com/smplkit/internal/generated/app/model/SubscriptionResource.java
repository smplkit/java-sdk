...
import com.smplkit.internal.generated.app.model.SubscriptionAttributes;
...
public class SubscriptionResource {
  ...
  public SubscriptionResource attributes(@jakarta.annotation.Nonnull SubscriptionAttributes attributes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAttributes(@jakarta.annotation.Nonnull SubscriptionAttributes attributes) {
    this.attributes = attributes;
  }
