...
public class ContextListResponse {
  ...
  public ContextListResponse data(@jakarta.annotation.Nonnull List<ContextResource> data) {
    this.data = data;
    return this;
  }

  public ContextListResponse addDataItem(ContextResource dataItem) {
    if (this.data == null) {
  ...
  public List<ContextResource> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<ContextResource> data) {
    this.data = data;
  }
