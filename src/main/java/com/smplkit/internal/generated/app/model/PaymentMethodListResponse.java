...
@JsonPropertyOrder({
  ...
  PaymentMethodListResponse.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class PaymentMethodListResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @jakarta.annotation.Nonnull
  private List<PaymentMethodResource> data = new ArrayList<>();
  ...
  public PaymentMethodListResponse data(@jakarta.annotation.Nonnull List<PaymentMethodResource> data) {
    this.data = data;
    return this;
  }

  public PaymentMethodListResponse addDataItem(PaymentMethodResource dataItem) {
    if (this.data == null) {
  ...
  public List<PaymentMethodResource> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<PaymentMethodResource> data) {
    this.data = data;
  }


  public PaymentMethodListResponse meta(@jakarta.annotation.Nonnull ListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  /**
   * Return true if this PaymentMethodListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, paymentMethodListResponse.data) &&
        Objects.equals(this.meta, paymentMethodListResponse.meta);
  }
