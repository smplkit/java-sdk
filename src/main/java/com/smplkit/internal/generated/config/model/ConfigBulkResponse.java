 ...
 */
@JsonPropertyOrder({
  ConfigBulkResponse.JSON_PROPERTY_REGISTERED
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class ConfigBulkResponse {
  public static final String JSON_PROPERTY_REGISTERED = "registered";
  @jakarta.annotation.Nonnull
  private Integer registered;

  public ConfigBulkResponse() { 
  }

  public ConfigBulkResponse registered(@jakarta.annotation.Nonnull Integer registered) {
  ...
  /**
   * Return true if this ConfigBulkResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConfigBulkResponse configBulkResponse = (ConfigBulkResponse) o;
    return Objects.equals(this.registered, configBulkResponse.registered);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigBulkResponse {\n");
