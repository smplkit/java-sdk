 ...
 */
@JsonPropertyOrder({
  ConfigResponse.JSON_PROPERTY_DATA
})
...
public class ConfigResponse {
  ...
  public ConfigResponse data(@jakarta.annotation.Nonnull ConfigResource data) {
    this.data = data;
    return this;
  }
  ...
  /**
   * Return true if this ConfigResponse object is equal to o.
   */
  @Override
