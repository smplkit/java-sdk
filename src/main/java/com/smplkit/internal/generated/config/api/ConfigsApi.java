...
public class ConfigsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ConfigListResponse listConfigs(@jakarta.annotation.Nullable String filterParent, @jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal) throws ApiException {
    return listConfigs(filterParent, sort, pageNumber, pageSize, metaTotal, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ConfigListResponse listConfigs(@jakarta.annotation.Nullable String filterParent, @jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
    ApiResponse<ConfigListResponse> localVarResponse = listConfigsWithHttpInfo(filterParent, sort, pageNumber, pageSize, metaTotal, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ConfigListResponse> listConfigsWithHttpInfo(@jakarta.annotation.Nullable String filterParent, @jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal) throws ApiException {
    return listConfigsWithHttpInfo(filterParent, sort, pageNumber, pageSize, metaTotal, null);
  }
   ...
   */
  public ApiResponse<ConfigListResponse> listConfigsWithHttpInfo(@jakarta.annotation.Nullable String filterParent, @jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listConfigsRequestBuilder(filterParent, sort, pageNumber, pageSize, metaTotal, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder listConfigsRequestBuilder(@jakarta.annotation.Nullable String filterParent, @jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
