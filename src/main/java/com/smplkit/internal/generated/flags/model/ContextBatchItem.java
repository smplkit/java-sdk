 ...
 */
@JsonPropertyOrder({
  ContextBatchItem.JSON_PROPERTY_TYPE,
  ContextBatchItem.JSON_PROPERTY_KEY,
  ContextBatchItem.JSON_PROPERTY_ATTRIBUTES
})
...
public class ContextBatchItem {
  ...
  public ContextBatchItem() { 
  }

  public ContextBatchItem type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public ContextBatchItem key(@jakarta.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }

  /**
   * Entity identifier (e.g., &#39;user-123&#39;)
   * @return key
   */
  @jakarta.annotation.Nonnull
  ...
  public ContextBatchItem attributes(@jakarta.annotation.Nullable Map<String, Object> attributes) {
    this.attributes = attributes;
    return this;
  }

  public ContextBatchItem putAttributesItem(String key, Object attributesItem) {
  ...
  /**
   * Return true if this ContextBatchItem object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ContextBatchItem contextBatchItem = (ContextBatchItem) o;
    return Objects.equals(this.type, contextBatchItem.type) &&
        Objects.equals(this.key, contextBatchItem.key) &&
        Objects.equals(this.attributes, contextBatchItem.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextBatchItem {\n");
