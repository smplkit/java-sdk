...
import com.smplkit.internal.generated.flags.model.ContextBatchRegister;
import com.smplkit.internal.generated.flags.model.ContextBatchResponse;
import com.smplkit.internal.generated.flags.model.ContextListResponse;
import com.smplkit.internal.generated.flags.model.ContextResponse;
...
public class ContextsApi {
   ...
   * Register Contexts
   * 
   * @param contextBatchRegister  (required)
   * @return ContextBatchResponse
   * @throws ApiException if fails to make API call
   */
  public ContextBatchResponse registerContexts(@jakarta.annotation.Nonnull ContextBatchRegister contextBatchRegister) throws ApiException {
    return registerContexts(contextBatchRegister, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ContextBatchResponse registerContexts(@jakarta.annotation.Nonnull ContextBatchRegister contextBatchRegister, Map<String, String> headers) throws ApiException {
    ApiResponse<ContextBatchResponse> localVarResponse = registerContextsWithHttpInfo(contextBatchRegister, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ContextBatchResponse> registerContextsWithHttpInfo(@jakarta.annotation.Nonnull ContextBatchRegister contextBatchRegister) throws ApiException {
    return registerContextsWithHttpInfo(contextBatchRegister, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ContextBatchResponse> registerContextsWithHttpInfo(@jakarta.annotation.Nonnull ContextBatchRegister contextBatchRegister, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = registerContextsRequestBuilder(contextBatchRegister, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("registerContexts", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
  ...
  private HttpRequest.Builder registerContextsRequestBuilder(@jakarta.annotation.Nonnull ContextBatchRegister contextBatchRegister, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'contextBatchRegister' is set
    if (contextBatchRegister == null) {
      throw new ApiException(400, "Missing the required parameter 'contextBatchRegister' when calling registerContexts");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/contexts/register";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(contextBatchRegister);
