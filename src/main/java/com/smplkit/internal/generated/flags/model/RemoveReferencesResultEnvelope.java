...
import com.smplkit.internal.generated.flags.model.RemoveReferencesResultResource;
...
public class RemoveReferencesResultEnvelope {
  ...
  public RemoveReferencesResultResource getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull RemoveReferencesResultResource data) {
    this.data = data;
  }
