...
import com.smplkit.internal.generated.flags.model.FlagSourceListResponse;
...
public class FlagSourcesApi {
  ...
  public FlagSourcesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public FlagSourcesApi(ApiClient apiClient) {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listAllFlagSources", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<FlagSourceListResponse>(
        ...
        FlagSourceListResponse responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<FlagSourceListResponse>() {});
  ...
  private HttpRequest.Builder listAllFlagSourcesRequestBuilder(@jakarta.annotation.Nullable String filterEnvironment, @jakarta.annotation.Nullable String filterService, Map<String, String> headers) throws ApiException {
    ...
    String localVarPath = "/api/v1/flag_sources";
  ...
  public ApiResponse<FlagSourceListResponse> listFlagSourcesWithHttpInfo(@jakarta.annotation.Nonnull String id, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listFlagSources", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<FlagSourceListResponse>(
