 ...
 */
@JsonPropertyOrder({
  ActionListLinks.JSON_PROPERTY_NEXT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class ActionListLinks {
  public static final String JSON_PROPERTY_NEXT = "next";
  private JsonNullable<String> next = JsonNullable.<String>undefined();

  public ActionListLinks() { 
  }

  public ActionListLinks next(@jakarta.annotation.Nullable String next) {
  ...
  /**
   * Return true if this ActionListLinks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ActionListLinks actionListLinks = (ActionListLinks) o;
    return equalsNullable(this.next, actionListLinks.next);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionListLinks {\n");
