...
import com.smplkit.internal.generated.audit.model.UsageResource;
...
@JsonPropertyOrder({
  ...
  UsageResponse.JSON_PROPERTY_META
})
...
public class UsageResponse {
  ...
  public UsageResponse data(@jakarta.annotation.Nonnull List<UsageResource> data) {
    this.data = data;
    return this;
  }

  public UsageResponse addDataItem(UsageResource dataItem) {
    if (this.data == null) {
  ...
  public UsageResponse meta(@jakarta.annotation.Nonnull ListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, usageResponse.data) &&
        Objects.equals(this.meta, usageResponse.meta);
  }
