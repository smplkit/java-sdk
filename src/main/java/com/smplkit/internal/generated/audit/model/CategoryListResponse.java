...
@JsonPropertyOrder({
  ...
  CategoryListResponse.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class CategoryListResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @jakarta.annotation.Nonnull
  private List<CategoryResource> data = new ArrayList<>();
  ...
  public CategoryListResponse data(@jakarta.annotation.Nonnull List<CategoryResource> data) {
    this.data = data;
    return this;
  }

  public CategoryListResponse addDataItem(CategoryResource dataItem) {
    if (this.data == null) {
  ...
  public List<CategoryResource> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<CategoryResource> data) {
    this.data = data;
  }


  public CategoryListResponse meta(@jakarta.annotation.Nonnull ListMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, categoryListResponse.data) &&
        Objects.equals(this.meta, categoryListResponse.meta);
  }
