...
public class ResourceTypeListResponse {
  ...
  private List<ResourceTypeResource> data = new ArrayList<>();
  ...
  public ResourceTypeListResponse data(@jakarta.annotation.Nonnull List<ResourceTypeResource> data) {
    this.data = data;
    return this;
  }

  public ResourceTypeListResponse addDataItem(ResourceTypeResource dataItem) {
    if (this.data == null) {
  ...
  public List<ResourceTypeResource> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<ResourceTypeResource> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this ResourceTypeListResponse object is equal to o.
   */
  @Override
