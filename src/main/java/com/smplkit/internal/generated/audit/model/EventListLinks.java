 ...
 */
@JsonPropertyOrder({
  EventListLinks.JSON_PROPERTY_NEXT
})
...
public class EventListLinks {
  ...
  public EventListLinks() { 
  }

  public EventListLinks next(@jakarta.annotation.Nullable String next) {
  ...
  /**
   * Return true if this EventListLinks object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EventListLinks eventListLinks = (EventListLinks) o;
    return equalsNullable(this.next, eventListLinks.next);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventListLinks {\n");
