 ...
 */
@JsonPropertyOrder({
  ActionListMeta.JSON_PROPERTY_PAGE_SIZE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class ActionListMeta {
  public static final String JSON_PROPERTY_PAGE_SIZE = "page_size";
  @jakarta.annotation.Nonnull
  private Integer pageSize;

  public ActionListMeta() { 
  }

  public ActionListMeta pageSize(@jakarta.annotation.Nonnull Integer pageSize) {
  ...
  /**
   * Return true if this ActionListMeta object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ActionListMeta actionListMeta = (ActionListMeta) o;
    return Objects.equals(this.pageSize, actionListMeta.pageSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionListMeta {\n");
