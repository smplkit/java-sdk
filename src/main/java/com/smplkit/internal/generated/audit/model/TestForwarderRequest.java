...
public class TestForwarderRequest {
  ...
  public TestForwarderRequest headers(@jakarta.annotation.Nullable Map<String, String> headers) {
    this.headers = headers;
    return this;
  }

  public TestForwarderRequest putHeadersItem(String key, String headersItem) {
