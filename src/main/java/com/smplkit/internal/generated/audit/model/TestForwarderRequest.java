...
import com.smplkit.internal.generated.audit.model.SuccessStatus;
...
public class TestForwarderRequest {
  ...
  @jakarta.annotation.Nullable
  private SuccessStatus successStatus = 2xx;
  ...
  public TestForwarderRequest successStatus(@jakarta.annotation.Nullable SuccessStatus successStatus) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUCCESS_STATUS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSuccessStatus(@jakarta.annotation.Nullable SuccessStatus successStatus) {
    this.successStatus = successStatus;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSuccessStatus() != null) {
      joiner.add(getSuccessStatus().toUrlQueryString(prefix + "success_status" + suffix));
    }
