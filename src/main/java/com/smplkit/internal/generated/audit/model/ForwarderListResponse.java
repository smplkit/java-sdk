...
public class ForwarderListResponse {
  ...
  private List<ForwarderResource> data = new ArrayList<>();
  ...
  public ForwarderListResponse data(@jakarta.annotation.Nonnull List<ForwarderResource> data) {
    this.data = data;
    return this;
  }

  public ForwarderListResponse addDataItem(ForwarderResource dataItem) {
    if (this.data == null) {
  ...
  public List<ForwarderResource> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull List<ForwarderResource> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this ForwarderListResponse object is equal to o.
   */
  @Override
