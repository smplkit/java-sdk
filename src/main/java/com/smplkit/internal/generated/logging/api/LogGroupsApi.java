...
public class LogGroupsApi {
   ...
   * @param logGroupCreateRequest  (required)
   * @return LogGroupResponse
   * @throws ApiException if fails to make API call
   */
  public LogGroupResponse createLogGroup(@jakarta.annotation.Nonnull LogGroupCreateRequest logGroupCreateRequest) throws ApiException {
    return createLogGroup(logGroupCreateRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public LogGroupResponse createLogGroup(@jakarta.annotation.Nonnull LogGroupCreateRequest logGroupCreateRequest, Map<String, String> headers) throws ApiException {
    ApiResponse<LogGroupResponse> localVarResponse = createLogGroupWithHttpInfo(logGroupCreateRequest, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LogGroupResponse> createLogGroupWithHttpInfo(@jakarta.annotation.Nonnull LogGroupCreateRequest logGroupCreateRequest) throws ApiException {
    return createLogGroupWithHttpInfo(logGroupCreateRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LogGroupResponse> createLogGroupWithHttpInfo(@jakarta.annotation.Nonnull LogGroupCreateRequest logGroupCreateRequest, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createLogGroupRequestBuilder(logGroupCreateRequest, headers);
    try {
  ...
  private HttpRequest.Builder createLogGroupRequestBuilder(@jakarta.annotation.Nonnull LogGroupCreateRequest logGroupCreateRequest, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'logGroupCreateRequest' is set
    if (logGroupCreateRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'logGroupCreateRequest' when calling createLogGroup");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(logGroupCreateRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public LogGroupListResponse listLogGroups(@jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal) throws ApiException {
    return listLogGroups(sort, pageNumber, pageSize, metaTotal, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public LogGroupListResponse listLogGroups(@jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
    ApiResponse<LogGroupListResponse> localVarResponse = listLogGroupsWithHttpInfo(sort, pageNumber, pageSize, metaTotal, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LogGroupListResponse> listLogGroupsWithHttpInfo(@jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal) throws ApiException {
    return listLogGroupsWithHttpInfo(sort, pageNumber, pageSize, metaTotal, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LogGroupListResponse> listLogGroupsWithHttpInfo(@jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listLogGroupsRequestBuilder(sort, pageNumber, pageSize, metaTotal, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder listLogGroupsRequestBuilder(@jakarta.annotation.Nullable String sort, @jakarta.annotation.Nullable Integer pageNumber, @jakarta.annotation.Nullable Integer pageSize, @jakarta.annotation.Nullable Boolean metaTotal, Map<String, String> headers) throws ApiException {
