...
public class ServiceResource {
  ...
  public ServiceResource id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ServiceResource attributes(@jakarta.annotation.Nullable Object attributes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, serviceResource.id) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAttributes() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sattributes%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAttributes()))));
    }
